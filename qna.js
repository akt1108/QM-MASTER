            ...
            function marking(num){
                ...
                document.getElementById("a"+num).className += " hover:text-blue-500 underline"
                document.getElementById("b"+num).className += " hover:text-blue-500 underline"
                document.getElementById("c"+num).className += " hover:text-blue-500 underline"
                document.getElementById("d"+num).className += " hover:text-blue-500 underline"
            }
            ...
            function markingA(){
                ...
                document.getElementById("a"+num).classList.remove("hover:text-blue-500")
                document.getElementById("b"+num).classList.remove("hover:text-blue-500")
                document.getElementById("c"+num).classList.remove("hover:text-blue-500")
                document.getElementById("d"+num).classList.remove("hover:text-blue-500")
            }
            function markingB(){
                if (answer[num]=="a"){
